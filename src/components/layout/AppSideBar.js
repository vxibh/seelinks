...
import { faFileInvoice, faChartLine, faAnglesLeft, faFileLines } from '@fortawesome/free-solid-svg-icons';
...
export default function AppSideBar() {
    ...
    const commonLinkClasses = "flex gap-4 items-center font-bold";
    const activeLinkClasses = "text-blue-700";
    const inactiveLinkClasses = "text-gray-500";

    return (
        <nav className="inline-flex flex-col text-center mt-12 gap-8 mx-auto text-gray-700">
            ...
            <LogoutButton iconLeft={true} className={'flex gap-4 items-center'} iconClasses={'w-6 h-6 text-gray-500'}/>
